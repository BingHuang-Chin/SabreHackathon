...
(function () {
    ...
    window.Framework7 = function (params) {
        ...
        ************   FMK Photo Browser   ************
        ======================================================*/
        var FmkPhotoBrowser = function (params) {
            var pb = this, i;
            ...
            var navbarTemplate = pb.params.navbarTemplate ||
                '<div class="navbar">' +
                    '<div class="navbar-inner">' +
                        '<div class="left sliding">' +
                            '<a href="#" id="closeLink" class="link close-popup photo-browser-close-link {{#unless backLinkText}}icon-only{{/unless}} {{js "this.type === \'page\' ? \'back\' : \'\'"}}">' +
                                '<i class="icon icon-back {{iconsColorClass}}"></i>' +
                                '{{#if backLinkText}}<span>{{backLinkText}}</span>{{/if}}' +
                            '</a>' +
                        '</div>' +
                ...
                '</div>';
            var toolbarTemplate = pb.params.toolbarTemplate ||
                '<div class="toolbar" ng-controller="SelectionController">' +
                    '<div class="toolbar-inner">' +
                        '<a href="#" class="link" ng-repeat="gameChoice in gameChoices" ng-click="Selected(gameChoice.option)" ng-disabled="gameChoice.selected">{%gameChoice.option%}' +
                        '</a>' +
                    '</div>' +
                '</div>';
        ...
        app.fmkPhotoBrowser = function (params) {
            return new FmkPhotoBrowser(params);
        };
